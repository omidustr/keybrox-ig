...
cd /d "%~dp0"
echo ================================================
echo  KeyBrox Instagram Otomasyonu - GitHub yukleme
echo ================================================
echo.
git --version >nul 2>&1
if errorlevel 1 (
...
echo.
set /p REPO="Depo adresi (ornek https://github.com/kullanici/keybrox-ig.git): "
if "%REPO%"=="" (echo Adres girilmedi. & pause & exit /b 1)
if exist .git rmdir /s /q .git
git init -b main
git add -A
git -c user.name="Olcay" -c user.email="zobekci@gmail.com" commit -m "KeyBrox Instagram otomasyonu"
...
echo.
echo ================================================
echo  Yuklendi. Simdi Meta erisim anahtarini uretin.
echo  Adimlar: README.md
echo ================================================
pause
